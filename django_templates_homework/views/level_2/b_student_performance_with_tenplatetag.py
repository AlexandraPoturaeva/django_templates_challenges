...
def students_performance_view_optional(request: HttpRequest) -> HttpResponse:
    performances = [
    ...
    return render(request, 'level_2/students_performance_with_templatetag.html', context={"performances": performances})
